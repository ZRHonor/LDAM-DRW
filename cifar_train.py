...
def main():
    ...
    args.store_name = '_'.join([str(curr_time.year), str(curr_time.month), str(curr_time.day), str(curr_time.hour), str(curr_time.minute), args.dataset, args.arch, args.loss_type, args.train_rule, args.imb_type, str(args.imb_factor), args.exp_str, str(args.seed), str(args.beta)])
